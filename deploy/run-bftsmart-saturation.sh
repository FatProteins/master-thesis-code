...
for clients in 3072; do
  ...
  for machine in "zf01" "zf02" "zf03" "zf04"; do
    ssh drotarmel@${machine}.lab.dm.informatik.tu-darmstadt.de "docker run -d --net=host -v /home/drotarmel/bftsmart-saturation-split-9:/thesis/out thesis-bftsmart-client:0.1 ${per_instance} X X ${machine}.lab.dm.informatik.tu-darmstadt.de ${client_base}"
